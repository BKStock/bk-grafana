...
require (
	...
	github.com/dolthub/go-mysql-server v0.20.2 // @grafana/grafana-datasources-core-services
...
replace (
	...
	github.com/dolthub/go-mysql-server => github.com/grafana/go-mysql-server v0.20.2
