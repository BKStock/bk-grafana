...
Making the change before you add the saved query to your panel prevents unintended behaviors generated by introducing a variable that's not in your dashboard.
