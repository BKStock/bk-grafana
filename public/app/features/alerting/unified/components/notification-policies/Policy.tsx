...
const Policy = (props: PolicyComponentProps) => {
  ...
  const [localShowChildren, setLocalShowChildren] = useState(false);
            ...
            {pageOfChildren.map((child) => {
              ...
              return (
                <Policy
                  ...
                  expandedOverrides={props.expandedOverrides}
                  onTogglePolicyExpanded={props.onTogglePolicyExpanded}
                />
              );
            })}
            {showMore && (
      ...
      <Fragment key="reset-policy">
        ...
        <ConditionalWrap shouldWrap={provisioned} wrap={ProvisionedTooltip}>
          <Menu.Item
            ...
            icon="trash-alt"
            disabled={provisioned}
            label={t('alerting.use-create-dropdown-menu-actions.label-reset', 'Reset')}
