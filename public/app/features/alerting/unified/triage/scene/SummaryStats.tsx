...
function SummaryStatsContent() {
  ...
  const showFiring = alertStateFilter !== 'pending' && (instances.firing > 0 || rules.firing > 0);
  const showPending = alertStateFilter !== 'firing' && (instances.pending > 0 || rules.pending > 0);
