...
func (_m *AlertmanagerMock) ApplyConfig(_a0 context.Context, _a1 *models.AlertConfiguration, _a2 ...models.ApplyConfigOption) (bool, error) {
...
func (_c *AlertmanagerMock_ApplyConfig_Call) RunAndReturn(run func(context.Context, *models.AlertConfiguration, ...models.ApplyConfigOption) (bool, error)) *AlertmanagerMock_ApplyConfig_Call {
	_c.Call.Return(run)
	return _c
}
