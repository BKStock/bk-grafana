...
func NewAlertmanager(
	...
	err = func() error {
		defaultCfg, err := am.buildConfiguration(ctx, &models.AlertConfiguration{
			AlertmanagerConfiguration: cfg.DefaultConfig,
			Default:                   true,
		}, 0, notifier.IgnoreInvalidReceivers)
		if err != nil {
...
func (am *Alertmanager) ApplyConfig(ctx context.Context, config *models.AlertConfiguration, opts ...models.ApplyConfigOption) (bool, error) {
	if am.ready {
...
func (am *Alertmanager) CompareAndSendConfiguration(ctx context.Context, config *models.AlertConfiguration, autogenInvalidReceiverAction models.InvalidReceiversAction) (bool, error) {
	payload, err := am.buildConfiguration(ctx, config, config.CreatedAt, autogenInvalidReceiverAction)
	if err != nil {
	...
	return true, am.sendConfiguration(ctx, payload)
}
...
func (am *Alertmanager) buildConfiguration(ctx context.Context, config *models.AlertConfiguration, createdAtEpoch int64, autogenInvalidReceiverAction notifier.InvalidReceiversAction) (remoteClient.UserGrafanaConfig, error) {
	...
	payload.Default = config.Default || am.isDefaultConfiguration(cfgHash)
	return payload, nil
}
