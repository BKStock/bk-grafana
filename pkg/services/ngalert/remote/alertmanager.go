...
func NewAlertmanager(
	...
	err = func() error {
		...
		defaultCfg, err := am.buildConfiguration(ctx, parsed, notifier.IgnoreInvalidReceivers)
		if err != nil {
			return fmt.Errorf("unable to build default configuration: %w", err)
		}
...
func (am *Alertmanager) CompareAndSendConfiguration(ctx context.Context, config *apimodels.PostableUserConfig, autogenInvalidReceiverAction models.InvalidReceiversAction) (bool, error) {
	payload, err := am.buildConfiguration(ctx, config, autogenInvalidReceiverAction)
	if err != nil {
...
func (am *Alertmanager) buildConfiguration(ctx context.Context, c *apimodels.PostableUserConfig, autogenInvalidReceiverAction notifier.InvalidReceiversAction) (remoteClient.UserGrafanaConfig, error) {
